...
![Class Diagram URI 2990](https://user-images.githubusercontent.com/22635013/160806114-0cb18a81-5d09-4396-8544-4e2a71c9c0af.png)
...
```
***Departamento*** class implementation
...
```
***EmpregadoDeptDTO*** class implementation
...
***EmpregadoDeptProjection*** interface implementation
...
```
***Application Runner*** class final implementation
...
Result after run ***Application Runner*** class
